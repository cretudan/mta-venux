...
local SCOREBOARD_SERVER_NAME_COLOR	= { 255, 255, 255, 160 }		-- RGBA color for the server name text
...
local SCOREBOA					RD_BACKGROUND_IMAGE	= { 255, 255, 255, 40 }		-- RGBA color for the background image
...
local SCOREBOARD_SCROLL_BACKGROUND	= { 0, 0, 0, 10 }		-- RGBA color for the scroll background
local SCOREBOARD_SCROLL_FOREGROUND	= { 255, 255, 255, 30 }		-- RGBA color for the scroll foreground
